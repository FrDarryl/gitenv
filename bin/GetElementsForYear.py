...
def showUsage():
    print("format: " + sys.argv[0] + "BOMCalendar|ButlerLives|DOPCalendar|RSVMassReadings|TLMCalendar [Year(yyyy), default current year] [dow(0-6), default none]")
    sys.exit()

def getTLMCalendarForYear(yearToGet):
...
def getBOMCalendarForYear(yearToGet):
...
def getDOPCalendarForYear(yearToGet):
...
if whatToGet == "BOMCalendar":
    getBOMCalendarForYear(yearToGet)
elif whatToGet == "ButlerLives":
    getButlerLives()
elif whatToGet == "DOPCalendar":
    getDOPCalendarForYear(yearToGet)
elif whatToGet == "RSVMassReadings":
    getRSVMassReadingsForYear(yearToGet,dow)
elif whatToGet == "TLMCalendar":
    getTLMCalendarForYear(yearToGet)
else:
    showUsage()
